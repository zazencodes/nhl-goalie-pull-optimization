...
# err_p_goal_for =  mu_mcmc_std[2] * np.array([derivative(lambda mu: poisson.pmf(x_i, mu_step), x_i, dx=mu_step) for x_i in x])


# In[457]:


plt.hist(err_p_foal_for)


# Shoot, this is not going to work because poisson is not continuous
...
err_p_no_goal = calc_posteror_error(mu_mcmc_std[2])
